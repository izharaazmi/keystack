...
-- Insert sample users
INSERT INTO `cp_users` (`email`, `password`, `first_name`, `last_name`, `is_email_verified`, `role`, `is_active`) VALUES
('john.doe@company.com', '$2a$12$c0eptKHtO8T83vn6NJNmFeHXSnoJdKs6kpUIs7PFE2Uu25NFG5xK2', 'John', 'Doe', TRUE, 'user', TRUE),
...
INSERT INTO `cp_groups` (`name`, `description`, `created_by_id`, `is_active`) VALUES
('Development Team', 'Software development team members', 1, TRUE),
...
SELECT COUNT(*) as `total_credential_groups` FROM `cp_credential_groups`;
